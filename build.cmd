...
cl /nologo /W4 /O2 /TC /MT /D_CRT_SECURE_NO_WARNINGS /I"%SDL%\include\SDL2" /Fobuild\ /Febuild\jumpyball.exe ^
    jb_gfx.c jb_gfx_tile.c jb_bmp.c jb_track.c jb_level.c jb_trackrow_tiled.c jb_trackrow_sky.c jb_trackrow_ice_alt.c jb_trackrow_grass.c jb_trackrow_forest.c jb_ball.c jb_player.c jb_stage.c jb_text.c jb_mod.c jb_mod_effects.c jb_audio.c jb_menu.c jb_keyconfig.c jb_assets.c jb_appassets.c jb_platform_sdl2.c jb_main.c ^
